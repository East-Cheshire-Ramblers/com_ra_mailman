...
//      If com_ra_members is present, profiles may be present without an email/User rerord 
...
//        echo $sql . '<br>';
        ...
        if ($count == 0) {
            ...
            $sql = "SELECT p.id, p.home_group, p.membershipNumber, p.preferred_name,p.created ";
            ...
            $rows = $this->toolsHelper->getRows($sql);
            $table = new ToolsTable();
            $table->add_header("Group,Member No, Preferred Name,Created");
